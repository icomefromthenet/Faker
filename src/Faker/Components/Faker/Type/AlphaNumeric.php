            ...
            ->children()
                ...
                ->scalarNode(self::REPEAT_MIN)
                    ...
                    ->validate()
                        ...
                        ->then(function($x){
                             throw new Faker\Components\Faker\Exception('AlphaNumeric:: '.self::REPEAT_MIN .':: value must be an integer greater than or equal to zero');
                        })
                    ->end()
                ->end()
                ->scalarNode(self::REPEAT_MAX)
                    ...
                    ->validate()
                        ...
                        ->then(function($x){
                            throw new Faker\Components\Faker\Exception('AlphaNumeric:: '.self::REPEAT_MAX .':: value must be an integer greater than zero');
