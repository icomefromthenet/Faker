...
class DSNFactory implements ExtensionInterface
{
    ...
    protected static $drivers = array(
        'pdo_mysql'  => 'Faker\Components\Config\Driver\DSN\Mysql',
        'pdo_sqlite' => 'Faker\Components\Config\Driver\DSN\Sqlite',
        'pdo_pgsql'  => 'Faker\Components\Config\Driver\DSN\Pgsql',
        'pdo_oci'    => 'Faker\Components\Config\Driver\DSN\Oci',
        'oci8'       => 'Faker\Components\Config\Driver\DSN\Oci',
        'pdo_sqlsrv' => 'Faker\Components\Config\Driver\DSN\Sqlsrv',
    );
