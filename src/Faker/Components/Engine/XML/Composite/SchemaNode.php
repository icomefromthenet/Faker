...
use Faker\Components\Engine\DB\Composite\SchemaNode as BaseNode;
...
/**
  ...
  *  @since 1.0.4
  */
class SchemaNode extends BaseNode implements OptionInterface, SerializationInterface, VisitorInterface, CompositeInterface, TypeInterface
{
            ...
            ->children()
                ->scalarNode('name')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new InvalidConfigurationException('Schema::Name must be a string');
                        })
                    ->end()
                ->end()
                ->scalarNode('locale')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new InvalidConfigurationException('Schema::Locale not in valid list');
                        })
                    ->end()
                ->end()
