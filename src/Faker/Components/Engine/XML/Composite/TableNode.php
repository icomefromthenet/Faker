...
use Faker\Components\Engine\DB\Composite\TableNode as BaseNode;
...
/**
  ...
  *  @since 1.0.4
  */
class TableNode extends BaseNode implements OptionInterface, SerializationInterface, VisitorInterface, CompositeInterface, TypeInterface
{
    ...
    */
    ...
    public function validate()
    {
        ...
        # assign the rows to generate property from options
        $this->setRowsToGenerate($this->getOption('generate'));
            ...
            ->children()
                ->scalarNode('name')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new InvalidConfigurationException('Table::Name must be a string');
                        })
                    ->end()
                ->end()
                ->scalarNode('locale')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new InvalidConfigurationException('Table::Locale not in valid list');
                        })
                    ->end()
                ->end()
                ->scalarNode('randomGenerator')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new InvalidConfigurationException('Table::randomGenerator must not be empty or string');
                        })
                    ->end()
                ->end()
                ->scalarNode('generatorSeed')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new InvalidConfigurationException('Table::generatorSeed must be an integer');
                        })
                    ->end()
                ->end()
                ->scalarNode('generate')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new InvalidConfigurationException('Table::Generate must be and integer');
                        })
                    ->end()
                ->end()
            ->end()
