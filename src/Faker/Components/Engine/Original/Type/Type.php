...
use Faker\Components\Engine\Original\Utilities,
    ...
    Faker\Components\Engine\Original\Visitor\CacheInjectorVisitor,
    ...
    Faker\Components\Engine\Common\OptionInterface,
	...
	$rootNode->children()
		->scalarNode('name')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new \Faker\Components\Engine\Original\Exception('Type::Name must be a string');
                        })
                    ->end()
                ->end()
	      ->scalarNode('locale')
