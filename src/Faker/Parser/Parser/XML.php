...
use Faker\Parser\Exception\RegisterParserFailure;
use Faker\Parser\Exception\PHPXmlParserError;
use Faker\Parser\Exception as ParserException;
use Faker\Parser\Stack;
...
class XML implements ParserInterface
{
    ...
    /**
      * @var \Faker\Parser\Stack for the indexes
      */
    protected $stack;
    ...
    * @link https://github.com/symfony/DependencyInjection/blob/master/SimpleXMLElement.php
    * 
    */
