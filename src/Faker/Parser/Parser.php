...
use Faker\Parser\Exception\CantMakeTmpFile;
use Faker\Parser\Exception\AnalysisClassNotFound;
use Faker\Parser\Exception\InvalidFormatString;
...
class Parser
{
    ...
    function parse($filename, ParseOptions $parse_options = null)
    {
        ...
        $parse_class = "\\Faker\\Parser\\Parser\\" . strtoupper($parse_options->getParser());
