...
class SwapTest extends AbstractProject
{
    ...
    public function testNewObject()
    {
        ...
        $this->assertInstanceOf('Faker\Components\Engine\Original\Composite\CompositeInterface',new Swap($id,$parent,$event));
    ...
    public function testGenerateNoRepeat()
    {
        ...
        $child_a = $this->getMockBuilder('\Faker\Components\Engine\Original\Composite\When')->disableOriginalConstructor()->getMock();
        ...
        $child_b = $this->getMockBuilder('Faker\Components\Engine\Original\Composite\When')->disableOriginalConstructor()->getMock();
