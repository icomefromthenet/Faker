...
use Faker\Components\Engine\Original\Visitor\Relationships,
    Faker\Components\Engine\Original\Visitor\Relationship,
    Faker\Components\Engine\Original\Visitor\Relation,
...
class RelationshipTest extends AbstractProject
{
    ...
    public function testRelationships()
    {
        ...
        $this->assertInstanceOf('\Faker\Components\Engine\Original\Visitor\Relation',$foreign_relations[0]);
        ...
        $this->assertInstanceOf('\Faker\Components\Engine\Original\Visitor\Relation',$local_relations[0]);
