...
use Faker\Components\Engine\Original\Type\Text,
...
class TextTest extends AbstractProject
{
    ...
    public function testGenerate()
    {
        ...
        $locale->expects($this->exactly(5)) // 5 paragraphs called once per iteration.
               ->method('getFillerText')
               ->will($this->returnValue(self::$words));
        ...
        $txt = $type->generate(1,array()); 
        $this->assertContains('enim nisl elementum purus, accumsan interdum libero dui nec ipsum.',$txt);
    ...
    public function testGenerate2()
    {
        ...
        $txt = $type->generate(1,array()); 
        $this->assertContains('Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Lorem ipsum dolor sit amet',$txt);
