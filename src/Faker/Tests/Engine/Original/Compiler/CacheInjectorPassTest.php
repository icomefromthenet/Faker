...
use Faker\Components\Engine\Original\Compiler\Pass\CacheInjectorPass,
...
class CacheInjectorPassTest extends AbstractProject
{
    ...
    public function testCacheInjector()
    {
        ...
        $this->assertInstanceOf('\Faker\Components\Engine\Original\GeneratorCache',$columns_table1[0]->getGeneratorCache());
        
        #test that the cache been injected into the key consumer
        $fk = $columns_table2[0]->getChildren();
        $this->assertTrue($fk[0]->getUseCache());
        $this->assertInstanceOf('\Faker\Components\Engine\Original\GeneratorCache',$fk[0]->getGeneratorCache());
