...
use Faker\Components\Engine\Original\Composite\Table,
...
class TableTest extends AbstractProject
{
    ...
    public function testImplementsCompositeInterface()
    {
        ...
        $this->assertInstanceOf('Faker\Components\Engine\Original\Composite\CompositeInterface',$table);
    }
    ...
    public function testSchemaDispatchesEvent()
    {
        ...
        $event->expects($this->exactly(4))
              ...
              ->with($this->logicalOr(
                        ...
                        $this->isInstanceOf('\Faker\Components\Engine\Original\Formatter\GenerateEvent'));
