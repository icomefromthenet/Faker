...
use Faker\Components\Engine\Common\Builder\UniqueNumberTypeDefinition;
use Faker\Tests\Base\AbstractProject;

class UniqueNumberTypeDefinitionTest extends AbstractProject
{
    ...
    public function testTypeExists()
    {
        ...
        $type = new UniqueNumberTypeDefinition();
    ...
    public function testCreateType()
    {
        ...
        $this->assertInstanceOf('Faker\Components\Engine\Common\Type\UniqueNumber',$interalType);
    ...
    public function testTypePropertiesSet()
    {
        ...
        $typeNode = $type->format($format)->getNode();  
        $interalType = $typeNode->getType();
