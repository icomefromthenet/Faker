...
use Faker\Components\Engine\Common\Builder\NamesTypeDefinition;
use Faker\Tests\Base\AbstractProject;

class NamesDefinitionTest extends AbstractProject
{
    ...
    public function testCreateType()
    {
        ...
        $this->assertInstanceOf('Faker\Components\Engine\Common\Type\Names',$interalType);
