...
use Faker\Components\Engine\Common\Builder\AutoIncrementTypeDefinition;
use Faker\Tests\Base\AbstractProject;

class AutoIncrementDefinitionTest extends AbstractProject
{
    ...
    public function testTypeExists()
    {
        ...
        $type = new AutoIncrementTypeDefinition();
    ...
    public function testCreateType()
    {
        ...
        $typeNode = $type->startAtValue(100)->incrementByValue(500)->getNode();
        $interalType = $typeNode->getType();
        
        $this->assertInstanceOf('Faker\Components\Engine\Common\Type\AutoIncrement',$interalType);
    ...
    public function testTypePropertiesSet()
    {
        ...
        $this->assertEquals(100,$interalType->getOption('start'));
        $this->assertEquals(500,$interalType->getOption('increment'));
