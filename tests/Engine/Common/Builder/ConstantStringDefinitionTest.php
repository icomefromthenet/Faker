...
use Faker\Components\Engine\Common\Builder\ConstantStringTypeDefinition;
use Faker\Tests\Base\AbstractProject;

class ConstantStringDefinitionTest extends AbstractProject
{
    ...
    public function testTypeExists()
    {
        ...
        $type = new ConstantStringTypeDefinition();
    ...
    public function testCreateType()
    {
        ...
        $typeNode = $type->value('500.00')->getNode();
        $interalType = $typeNode->getType();
        
        $this->assertInstanceOf('Faker\Components\Engine\Common\Type\ConstantString',$interalType);
