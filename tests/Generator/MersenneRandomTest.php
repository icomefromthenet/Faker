...
use Faker\Tests\Base\AbstractProject,
    Faker\Generator\MersenneRandom;

class MersenneRandomTest extends AbstractProject
{
    
    public function testGeneratorImpementsInterface()
    {
        $this->assertInstanceOf('Faker\Generator\GeneratorInterface',new MersenneRandom());
    }
