...
class ContainerTest extends AbstractProject
{
    ...
    public function testWithClosure()
    {
        ...
        $this->assertInstanceOf('Faker\Tests\Base\AbstractProject', $pimple['test_service']);
    }
    ...
    public function testServicesShouldBeDifferent()
    {
        ...
        $this->assertInstanceOf('Faker\Tests\Base\AbstractProject', $serviceOne);

        $serviceTwo = $pimple['test_service'];
        $this->assertInstanceOf('Faker\Tests\Base\AbstractProject', $serviceTwo);
    ...
    */
    ...
    public function testNewProject()
    {
        ...
        $this->assertInstanceOf('\Faker\Project',$project);
