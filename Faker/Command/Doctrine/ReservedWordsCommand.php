...
use Doctrine\DBAL\Tools\Console\Command\ReservedWordsCommand as DoctrineReservedWordsCommand,
...
class ReservedWordsCommand extends DoctrineReservedWordsCommand 
{
    /**
