            ...
            ->children()
                ->scalarNode('paragraphs')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new \Faker\Components\Faker\Exception('Numeric::Paragraphs must be and integer');
                        })
                    ->end()
                ->end()
                ->scalarNode('maxlines')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new \Faker\Components\Faker\Exception('Numeric::maxlines must be and integer');
                        })
                    ->end()
                ->end()
                ->scalarNode('minlines')
                    ...
                    ->validate()
                        ...
                        ->then(function($v){
                            throw new \Faker\Components\Faker\Exception('Numeric::minlines must be and integer');
                        })
                    ->end()
                ->end()
            ->end();
